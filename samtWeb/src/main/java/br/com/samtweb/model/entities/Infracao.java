...
public class Infracao implements Serializable {
    ...
    private String dt_dataInfracaoUTC;
    ...
    @Column(name="nr_dataHoraInfracao", nullable=false, length=20)
    private String nr_dataHoraInfracao; 
    ...
    public String getDt_dataInfracaoUTC() {
        return dt_dataInfracaoUTC;
    }

    public void setDt_dataInfracaoUTC(String dt_dataInfracaoUTC) {
    ...
    public String getNr_dataHoraInfracao() {
        return nr_dataHoraInfracao;
    }

    public void setNr_dataHoraInfracao(String nr_dataHoraInfracao) {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 59 * hash + (this.id_hashInfracao != null ? this.id_hashInfracao.hashCode() : 0);
        return hash;
    }
