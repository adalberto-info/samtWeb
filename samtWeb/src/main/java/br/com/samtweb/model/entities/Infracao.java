...
public class Infracao implements Serializable {
    ...
    private BigDecimal nr_dataHoraInfracao; 
    ...
    public BigDecimal getNr_codigoLocal() {
        return nr_codigoLocal;
    }

    public void setNr_codigoLocal(BigDecimal nr_codigoLocal) {
    ...
    public void setNr_longitude(BigDecimal nr_longitude) {
    ...
    public void setNr_latitude(BigDecimal nr_latitude) {
        this.nr_latitude = nr_latitude;
    }

    public BigDecimal getNr_faixa() {
        return nr_faixa;
    }

    public void setNr_faixa(BigDecimal nr_faixa) {
    ...
    public BigDecimal getDataJuliana() {
        return dataJuliana;
    }

    public void setDataJuliana(BigDecimal dataJuliana) {
    ...
    public BigDecimal getNr_dataHoraInfracao() {
        return nr_dataHoraInfracao;
    }

    public void setNr_dataHoraInfracao(BigDecimal nr_dataHoraInfracao) {
    ...
    public BigDecimal getLg_veiculoEstado() {
        return lg_veiculoEstado;
    }

    public void setLg_veiculoEstado(BigDecimal lg_veiculoEstado) {
        this.lg_veiculoEstado = lg_veiculoEstado;
    }

    public BigDecimal getNr_tipoEquipamento() {
        return nr_tipoEquipamento;
    }

    public void setNr_tipoEquipamento(BigDecimal nr_tipoEquipamento) {
        this.nr_tipoEquipamento = nr_tipoEquipamento;
    }

    public BigDecimal getNr_porteVeiculo() {
        return nr_porteVeiculo;
    }

    public void setNr_porteVeiculo(BigDecimal nr_porteVeiculo) {
        this.nr_porteVeiculo = nr_porteVeiculo;
    }

    public BigDecimal getNr_tamanhoVeiculo() {
        return nr_tamanhoVeiculo;
    }

    public void setNr_tamanhoVeiculo(BigDecimal nr_tamanhoVeiculo) {
        this.nr_tamanhoVeiculo = nr_tamanhoVeiculo;
    }

    public BigDecimal getNr_classificacaoVeiculo() {
        return nr_classificacaoVeiculo;
    }

    public void setNr_classificacaoVeiculo(BigDecimal nr_classificacaoVeiculo) {
        this.nr_classificacaoVeiculo = nr_classificacaoVeiculo;
    }

    public BigDecimal getNr_sentidoVeiculo() {
        return nr_sentidoVeiculo;
    }

    public void setNr_sentidoVeiculo(BigDecimal nr_sentidoVeiculo) {
        this.nr_sentidoVeiculo = nr_sentidoVeiculo;
    }

    public BigDecimal getNr_velocidadePermitida() {
        return nr_velocidadePermitida;
    }

    public void setNr_velocidadePermitida(BigDecimal nr_velocidadePermitida) {
        this.nr_velocidadePermitida = nr_velocidadePermitida;
    }

    public BigDecimal getNr_velocidadeTolerada() {
        return nr_velocidadeTolerada;
    }

    public void setNr_velocidadeTolerada(BigDecimal nr_velocidadeTolerada) {
        this.nr_velocidadeTolerada = nr_velocidadeTolerada;
    }

    public BigDecimal getNr_velocidadeRegistrada() {
        return nr_velocidadeRegistrada;
    }

    public void setNr_velocidadeRegistrada(BigDecimal nr_velocidadeRegistrada) {
        this.nr_velocidadeRegistrada = nr_velocidadeRegistrada;
    }

    public BigDecimal getNr_velocidadeConsiderada() {
        return nr_velocidadeConsiderada;
    }

    public void setNr_velocidadeConsiderada(BigDecimal nr_velocidadeConsiderada) {
        this.nr_velocidadeConsiderada = nr_velocidadeConsiderada;
    }

    public BigDecimal getNr_tempoPerdaoSemaforo() {
        return nr_tempoPerdaoSemaforo;
    }

    public void setNr_tempoPerdaoSemaforo(BigDecimal nr_tempoPerdaoSemaforo) {
        this.nr_tempoPerdaoSemaforo = nr_tempoPerdaoSemaforo;
    }

    public BigDecimal getNr_tempoPerdaoParada() {
        return nr_tempoPerdaoParada;
    }

    public void setNr_tempoPerdaoParada(BigDecimal nr_tempoPerdaoParada) {
    ...
    public BigDecimal getNr_gravaTarja() {
        return nr_gravaTarja;
    }

    public void setNr_gravaTarja(BigDecimal nr_gravaTarja) {
        this.nr_gravaTarja = nr_gravaTarja;
    }

    public BigDecimal getNr_posicaoTarja() {
        return nr_posicaoTarja;
    }

    public void setNr_posicaoTarja(BigDecimal nr_posicaoTarja) {
        this.nr_posicaoTarja = nr_posicaoTarja;
    }

    public BigDecimal getNr_numeroLinhasTarja() {
        return nr_numeroLinhasTarja;
    }

    public void setNr_numeroLinhasTarja(BigDecimal nr_numeroLinhasTarja) {
        this.nr_numeroLinhasTarja = nr_numeroLinhasTarja;
    }

    public BigDecimal getNr_tipoImagem() {
        return nr_tipoImagem;
    }

    public void setNr_tipoImagem(BigDecimal nr_tipoImagem) {
        this.nr_tipoImagem = nr_tipoImagem;
    }

    public BigDecimal getNr_distancaiFaixaRetencao() {
        return nr_distancaiFaixaRetencao;
    }

    public void setNr_distancaiFaixaRetencao(BigDecimal nr_distancaiFaixaRetencao) {
        this.nr_distancaiFaixaRetencao = nr_distancaiFaixaRetencao;
    }

    public BigDecimal getNr_distanciaRegistrada() {
        return nr_distanciaRegistrada;
    }

    public void setNr_distanciaRegistrada(BigDecimal nr_distanciaRegistrada) {
        this.nr_distanciaRegistrada = nr_distanciaRegistrada;
    }

    public BigDecimal getNr_numeroSequencialVeiculo() {
        return nr_numeroSequencialVeiculo;
    }

    public void setNr_numeroSequencialVeiculo(BigDecimal nr_numeroSequencialVeiculo) {
        this.nr_numeroSequencialVeiculo = nr_numeroSequencialVeiculo;
    }

    public BigDecimal getNr_numeroSequencialVeiculoInfrator() {
        return nr_numeroSequencialVeiculoInfrator;
    }

    public void setNr_numeroSequencialVeiculoInfrator(BigDecimal nr_numeroSequencialVeiculoInfrator) {
        this.nr_numeroSequencialVeiculoInfrator = nr_numeroSequencialVeiculoInfrator;
    }

    public BigDecimal getNr_numeroSequencialInfracao() {
        return nr_numeroSequencialInfracao;
    }

    public void setNr_numeroSequencialInfracao(BigDecimal nr_numeroSequencialInfracao) {
    ...
    public BigDecimal getFk_enquadramento() {
        return fk_enquadramento;
    }

    public void setFk_enquadramento(BigDecimal fk_enquadramento) {
        this.fk_enquadramento = fk_enquadramento;
    }

    public BigDecimal getFk_processo() {
        return fk_processo;
    }

    public void setFk_processo(BigDecimal fk_processo) {
        this.fk_processo = fk_processo;
    }

    public BigDecimal getFk_status() {
        return fk_status;
    }

    public void setFk_status(BigDecimal fk_status) {
        this.fk_status = fk_status;
    }

    public BigDecimal getFk_tipoInconsistencia() {
        return fk_tipoInconsistencia;
    }

    public void setFk_tipoInconsistencia(BigDecimal fk_tipoInconsistencia) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 97 * hash + (this.id_hashInfracao != null ? this.id_hashInfracao.hashCode() : 0);
        return hash;
    }
